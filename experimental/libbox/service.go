...
func NewService(configContent string, platformInterface PlatformInterface) (*BoxService, error) {
	...
	return NewServiceWithContext(configContent, platformInterface, ctx)
}

func NewServiceWithContext(configContent string, platformInterface PlatformInterface, ctx context.Context) (*BoxService, error) {
